...
import cardone from "../../../assets/offers/pcardone.svg";
import cardtwo from "../../../assets/offers/pcardtwo.svg";
import cardthree from "../../../assets/offers/pcardthree.svg";
import cardfour from "../../../assets/offers/pcardfour.svg";
import cardfive from "../../../assets/offers/pcardfive.svg";
import carsix from "../../../assets/offers/pcardsix.svg";
import carseven from "../../../assets/offers/pcardseven.svg";
  ...
  return (
    <Grid container spacing={2}>
      {cards.map((card, index) => (
        <Grid item lg={3} md={6} xs={12} sx={{ display: "flex", justifyContent: 'center' }} key={index}>
          <Card
            style={{
              width: '100%',
              maxWidth: '448.714px',
